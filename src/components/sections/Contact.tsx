      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 justify-items-center">
          <div className="text-center">
            <img src={publicUrl('/images/wechat-qr.png')} alt="WeChat QR Code" className="w-32 h-32 mx-auto mb-4" />
            <p className="text-sm font-medium" style={{ color: "#efd88f" }}>WECHAT</p>
          </div>
          <div className="text-center">
            <img src={publicUrl('/images/xiaohongshu-qr.png')} alt="Xiaohongshu QR Code" className="w-32 h-32 mx-auto mb-4" />
            <p className="text-sm font-medium" style={{ color: "#efd88f" }}>LAVITA.NYC</p>
          </div>
          <div className="text-center">
            <img src={publicUrl('/images/instagram-qr.png')} alt="Instagram QR Code" className="w-32 h-32 mx-auto mb-4" />
            <p className="text-sm font-medium" style={{ color: "#efd88f" }}>INSTAGRAM</p>
          </div>
          <div className="text-center">
            <img src={publicUrl('/images/facebook-qr.png')} alt="Facebook QR Code" className="w-32 h-32 mx-auto mb-4" />
