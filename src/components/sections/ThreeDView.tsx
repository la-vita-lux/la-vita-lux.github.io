  ...
  const units = [
    {
      ...
      thumbnail: publicUrl("/images/thumbnails/C-inside-light.png"),
    },
    {
      id: "K",
      title: "K Unit (一房)",
      url: "https://vr.justeasy.cn/view/1k3w7731u6146656-1732865148.html",
      thumbnail: publicUrl("/images/thumbnails/K-inside-light.png"),
    },
    {
      id: "F",
      title: "F Unit (一房)",
      url: "https://vr.justeasy.cn/view/1z7283qj864269u2-1731522371.html",
      thumbnail: publicUrl("/images/thumbnails/F-inside-light.png"),
    },
    {
      id: "A",
      title: "A Unit (Studio)",
      url: "https://vr.justeasy.cn/view/16v73176114b5697-1733507443.html",
      thumbnail: publicUrl("/images/thumbnails/A-inside-light.png"),
    },
  ] as const
          ...
          >
            <img
              ...
              onError={(e) => {
                ...
                e.currentTarget.src = publicUrl("/images/lavita-logo.png")
              }}
            />
